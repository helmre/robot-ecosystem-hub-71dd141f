    ...
    <div className="relative z-10 px-4 md:px-6">
      <div className="mx-auto max-w-[1380px] bg-[rgba(119,119,119,0.3)] backdrop-blur-[15px] rounded-[22px] border border-[rgba(79,79,79,0.3)] h-[72px] mt-[27px] flex items-center justify-between px-6">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <span className="text-white font-bold text-sm">NeuronSuite</span>
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex">
            <button className="bg-white text-[#111921] rounded-[11px] h-[51px] w-[126px] text-sm">
              Get a Demo
            </button>
            <button className="bg-[#00AEFF] text-white rounded-[11px] h-[51px] w-[126px] ml-4 text-sm">
              Log In
            </button>
          </div>
